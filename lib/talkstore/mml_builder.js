...
//
// params must have:
// `query`           - query condition to constrain the map by (can be an array), contains {engine_home, dbname, layer, filter}
...
function MMLBuilder(params, options) {
    ...
    // TODO: check required [engine_home, dbname, layer, filter]
